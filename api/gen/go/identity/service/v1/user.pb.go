...
const (
	ActivationMode_IMMEDIATE        ActivationMode = 0
	ActivationMode_EMAIL_INVITATION ActivationMode = 1
)
...
func (User_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_identity_service_v1_user_proto_enumTypes[2].Descriptor()
}

func (User_Status) Type() protoreflect.EnumType {
	return &file_identity_service_v1_user_proto_enumTypes[2]
}
...
type CreateUserRequest struct {
	...
	ActivationMode ActivationMode         `protobuf:"varint,3,opt,name=activation_mode,json=activationMode,proto3,enum=identity.service.v1.ActivationMode" json:"activation_mode,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *CreateUserRequest) GetActivationMode() ActivationMode {
	if x != nil {
...
const file_identity_service_v1_user_proto_rawDesc = "" +
	...
	"\bpassword\x18\x02 \x01(\tB\x1a\xbaG\x17\x18\x01\x92\x02\x12用户登录密码H\x00R\bpassword\x88\x01\x01\x12L\n" +
	"\x0factivation_mode\x18\x03 \x01(\x0e2#.identity.service.v1.ActivationModeR\x0eactivationModeB\v\n" +
	"\t_password\"\xf4\x03\n" +
	...
	"\x05count\x18\x01 \x01(\x04R\x05count*5\n" +
	"\x0eActivationMode\x12\r\n" +
	"\tIMMEDIATE\x10\x00\x12\x14\n" +
	"\x10EMAIL_INVITATION\x10\x012\xa3\x05\n" +
	"\vUserService\x12J\n" +
...
var file_identity_service_v1_user_proto_goTypes = []any{
	...
	(User_Status)(0),                 // 2: identity.service.v1.User.Status
	(*User)(nil),                     // 3: identity.service.v1.User
	(*ListUserResponse)(nil),         // 4: identity.service.v1.ListUserResponse
	(*GetUserRequest)(nil),           // 5: identity.service.v1.GetUserRequest
	(*CreateUserRequest)(nil),        // 6: identity.service.v1.CreateUserRequest
	(*UpdateUserRequest)(nil),        // 7: identity.service.v1.UpdateUserRequest
	(*DeleteUserRequest)(nil),        // 8: identity.service.v1.DeleteUserRequest
	(*UserExistsRequest)(nil),        // 9: identity.service.v1.UserExistsRequest
	(*UserExistsResponse)(nil),       // 10: identity.service.v1.UserExistsResponse
	(*BatchCreateUsersRequest)(nil),  // 11: identity.service.v1.BatchCreateUsersRequest
	(*BatchCreateUsersResponse)(nil), // 12: identity.service.v1.BatchCreateUsersResponse
...
var file_identity_service_v1_user_proto_depIdxs = []int32{
	...
	7,  // 23: identity.service.v1.UserService.Update:input_type -> identity.service.v1.UpdateUserRequest
