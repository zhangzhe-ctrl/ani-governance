...
type CreateTenantWithAdminUserRequest struct {
	...
	ActivationMode ActivationMode         `protobuf:"varint,4,opt,name=activation_mode,json=activationMode,proto3,enum=identity.service.v1.ActivationMode" json:"activation_mode,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *CreateTenantWithAdminUserRequest) GetActivationMode() ActivationMode {
	if x != nil {
		return x.ActivationMode
	}
	return ActivationMode_IMMEDIATE
}
...
type QuotaUsage struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Deprecated: Marked as deprecated in identity/service/v1/tenant.proto.
	QuotaType  PlanQuota_QuotaType `protobuf:"varint,1,opt,name=quota_type,json=quotaType,proto3,enum=identity.service.v1.PlanQuota_QuotaType" json:"quota_type,omitempty"` // 配额类型（deprecated）
	QuotaValue uint64              `protobuf:"varint,2,opt,name=quota_value,json=quotaValue,proto3" json:"quota_value,omitempty"`                                           // 配额上限值
	// 稳定配额编码；GPU 等新项目只有本字段，旧枚举投影为 UNSPECIFIED。
	QuotaCode     string `protobuf:"bytes,3,opt,name=quota_code,json=quotaCode,proto3" json:"quota_code,omitempty"` // 配额编码
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *QuotaUsage) GetQuotaCode() string {
	if x != nil {
		return x.QuotaCode
	}
	return ""
...
const file_identity_service_v1_tenant_proto_rawDesc = "" +
	...
	"\x05exist\x18\x01 \x01(\bR\x05exist\"\xf0\x01\n" +
	...
	"\x0factivation_mode\x18\x04 \x01(\x0e2#.identity.service.v1.ActivationModeR\x0eactivationMode\"+\n" +
	...
	"\x02id\x18\x01 \x01(\rB\x10\xbaG\r\x18\x01\x92\x02\b租户IDR\x02id\"\xff\x01\n" +
	"\n" +
	"QuotaUsage\x12\x85\x01\n" +
	"\n" +
	"quota_type\x18\x01 \x01(\x0e2(.identity.service.v1.PlanQuota.QuotaTypeB<\xbaG7\x92\x024配额类型（deprecated：旧三项兼容投影）\x18\x01R\tquotaType\x126\n" +
	"\vquota_value\x18\x02 \x01(\x04B\x15\xbaG\x12\x92\x02\x0f配额上限值R\n" +
	"quotaValue\x121\n" +
	"\n" +
	"quota_code\x18\x03 \x01(\tB\x12\xbaG\x0f\x92\x02\f配额编码R\tquotaCode\"\xd6\x03\n" +
	"\vTenantUsage\x12+\n" +
...
var file_identity_service_v1_tenant_proto_goTypes = []any{
	...
	(ActivationMode)(0),                      // 23: identity.service.v1.ActivationMode
	(PlanQuota_QuotaType)(0),                 // 24: identity.service.v1.PlanQuota.QuotaType
...
var file_identity_service_v1_tenant_proto_depIdxs = []int32{
	...
	23, // 17: identity.service.v1.CreateTenantWithAdminUserRequest.activation_mode:type_name -> identity.service.v1.ActivationMode
	24, // 18: identity.service.v1.QuotaUsage.quota_type:type_name -> identity.service.v1.PlanQuota.QuotaType
	17, // 19: identity.service.v1.TenantUsage.quotas:type_name -> identity.service.v1.QuotaUsage
	25, // 20: identity.service.v1.TenantService.List:input_type -> pagination.PagingRequest
	25, // 21: identity.service.v1.TenantService.Count:input_type -> pagination.PagingRequest
	5,  // 22: identity.service.v1.TenantService.Get:input_type -> identity.service.v1.GetTenantRequest
	9,  // 23: identity.service.v1.TenantService.BatchCreate:input_type -> identity.service.v1.BatchCreateTenantsRequest
	6,  // 24: identity.service.v1.TenantService.Create:input_type -> identity.service.v1.CreateTenantRequest
	7,  // 25: identity.service.v1.TenantService.Update:input_type -> identity.service.v1.UpdateTenantRequest
	8,  // 26: identity.service.v1.TenantService.Delete:input_type -> identity.service.v1.DeleteTenantRequest
	11, // 27: identity.service.v1.TenantService.TenantExists:input_type -> identity.service.v1.TenantExistsRequest
	15, // 28: identity.service.v1.TenantService.AssignTenantAdmin:input_type -> identity.service.v1.AssignTenantAdminRequest
	16, // 29: identity.service.v1.TenantService.GetUsage:input_type -> identity.service.v1.GetTenantUsageRequest
	19, // 30: identity.service.v1.TenantService.CleanupData:input_type -> identity.service.v1.CleanupTenantDataRequest
	4,  // 31: identity.service.v1.TenantService.List:output_type -> identity.service.v1.ListTenantResponse
	14, // 32: identity.service.v1.TenantService.Count:output_type -> identity.service.v1.CountTenantResponse
	3,  // 33: identity.service.v1.TenantService.Get:output_type -> identity.service.v1.Tenant
	10, // 34: identity.service.v1.TenantService.BatchCreate:output_type -> identity.service.v1.BatchCreateTenantsResponse
	26, // 35: identity.service.v1.TenantService.Create:output_type -> google.protobuf.Empty
	26, // 36: identity.service.v1.TenantService.Update:output_type -> google.protobuf.Empty
	26, // 37: identity.service.v1.TenantService.Delete:output_type -> google.protobuf.Empty
	12, // 38: identity.service.v1.TenantService.TenantExists:output_type -> identity.service.v1.TenantExistsResponse
	26, // 39: identity.service.v1.TenantService.AssignTenantAdmin:output_type -> google.protobuf.Empty
	18, // 40: identity.service.v1.TenantService.GetUsage:output_type -> identity.service.v1.TenantUsage
	26, // 41: identity.service.v1.TenantService.CleanupData:output_type -> google.protobuf.Empty
