...
type ApiAuditLog struct {
	...
	SubjectType    *string                `protobuf:"bytes,6,opt,name=subject_type,proto3,oneof" json:"subject_type,omitempty"`
	SubjectId      *uint32                `protobuf:"varint,7,opt,name=subject_id,proto3,oneof" json:"subject_id,omitempty"`
...
func (x *ApiAuditLog) GetSubjectType() string {
...
func (x *ApiAuditLog) GetSubjectId() uint32 {
...
const file_audit_service_v1_api_audit_log_proto_rawDesc = "" +
	...
	"\n" +
	"subject_id\x18\a \x01(\rH\x01R\n" +
	"subject_id\x88\x01\x01\x12/\n" +
	"\x02id\x18\x01 \x01(\rB\x1a\xbaG\x17\x92\x02\x14接口审计日志IDH\x02R\x02id\x88\x01\x01\x120\n" +
	"\ttenant_id\x18\x02 \x01(\rB\x0e\xbaG\v\x92\x02\b租户IDH\x03R\btenantId\x88\x01\x01\x128\n" +
	"\vtenant_name\x18\x03 \x01(\tB\x12\xbaG\x0f\x92\x02\f租户名称H\x04R\n" +
	"tenantName\x88\x01\x01\x12,\n" +
	"\auser_id\x18\x04 \x01(\rB\x0e\xbaG\v\x92\x02\b用户IDH\x05R\x06userId\x88\x01\x01\x120\n" +
