...
type AccessKeyServiceClient interface {
	...
	// 创建访问凭证（响应中的 secret_key 仅本次返回，服务端加密存储）
	...
	// 删除访问凭证
	Delete(ctx context.Context, in *v11.DeleteAccessKeyRequest, opts ...grpc.CallOption) (*v11.DeleteAccessKeyResponse, error)
...
func (c *accessKeyServiceClient) Delete(ctx context.Context, in *v11.DeleteAccessKeyRequest, opts ...grpc.CallOption) (*v11.DeleteAccessKeyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v11.DeleteAccessKeyResponse)
...
func (UnimplementedAccessKeyServiceServer) Delete(context.Context, *v11.DeleteAccessKeyRequest) (*v11.DeleteAccessKeyResponse, error) {
