...
const file_conf_v1_kratos_conf_middleware_proto_rawDesc = "" +
	...
	"\asummary\x18\x04 \x01(\bR\asummaryB\x96\x01\n" +
	"\bcom.confB\x19KratosConfMiddlewareProtoP\x01Z?go-wind-admin/pkg/localdeps/kratos-bootstrap/api/gen/go/conf/v1\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"
