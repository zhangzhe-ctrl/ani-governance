...
const file_conf_v1_kratos_conf_oss_proto_rawDesc = "" +
	...
	"\x06_minioB\x05\n" +
	"\x03_s3B\x8f\x01\n" +
	"\bcom.confB\x12KratosConfOssProtoP\x01Z?go-wind-admin/pkg/localdeps/kratos-bootstrap/api/gen/go/conf/v1\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"
