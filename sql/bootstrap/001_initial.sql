...
BEGIN
  ...
  {"component":"app/system/file/index.vue","meta":{"authority":["sys:platform_admin","sys:tenant_manager"],"icon":"lucide:file-search","order":4,"title":"menu.system.file"},"module":"SYSTEM","name":"FileManagement","parent_name":"System","path":"files","type":"MENU"},
